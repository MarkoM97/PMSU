...
public class PostsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button1 = (Button) findViewById(R.id.startReadPostBtn);
        ...
        Button button2 = (Button) findViewById(R.id.startCreatePostBtn);
        ...
        Button button3 = (Button) findViewById(R.id.startSettingsBtn);
